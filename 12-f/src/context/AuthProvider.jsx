...
export const AuthProvider = ({ children }) => {
  ...
  const [token, setToken] = useState(() => sessionStorage.getItem('ecommerce_token') || null);
  ...
  return (
    <AuthContext.Provider value={{ token, user, isAuthenticated, login, logout, isAdmin: user?.role === "ADMIN" }}>
      {children}
